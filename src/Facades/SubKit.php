...
/**
 * @method static string checkout(string $planCode, ?string $userId = null, string $successUrl = '', string $cancelUrl = '', string $provider = 'stripe', int $quantity = 1, array $options = [])
