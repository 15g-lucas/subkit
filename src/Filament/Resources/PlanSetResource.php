            ...
            Section::make('URLs')
                ...
                ->schema([
                    TextInput::make('success_url')
                        ...
                        ->helperText('Redirect here after a successful checkout. Same-app URLs are signed automatically so you can protect the page with Laravel\'s signed middleware.'),
